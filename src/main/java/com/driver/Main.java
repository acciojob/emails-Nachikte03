...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        workspace.addMeeting(new Meeting(LocalTime.parse("13:30"), LocalTime.parse("15:00")));
        workspace.addMeeting(new Meeting(LocalTime.parse("18:41"), LocalTime.parse("19:10")));
